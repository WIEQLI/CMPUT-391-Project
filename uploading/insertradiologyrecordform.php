...
<html>
	<head>
		<!-- http://www.fyneworks.com/jquery/multiple-file-upload/  For multiple uploads-->
			...
			<div id="header">
				...
				<div id="content-wrap" class="styleform">
					...
					<form name="form1" action='php/insertradiologyrecord.php' enctype="multipart/form-data" method="post" class='ajaxform'>
						...
						<label for="imageupload">*Image(s) to include:</label><input id="imageupload" name="imageuploads[]" class='multi' type="file"/></br>
